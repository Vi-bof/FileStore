...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8178427141")
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002343526330")) #Your db channel Id
...
DB_NAME = os.environ.get("DATABASE_NAME", "vickshar")
#--------------------------------------------
